...
from .views import TopUpView, TopUpSuccessView, TopUpCancelView, PaymentView, StripeSuccessView, StripeCancelView, transactionHistoryView
...
urlpatterns = [
    ...
    path('pay/<uuid:bid_uuid>/', PaymentView.as_view()),
    ...
    path('transactions/<str:history_type>/', transactionHistoryView.as_view()),
]
